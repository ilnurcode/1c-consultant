...
MCP не требуется для канонического Python workflow. Запускай его только когда хосту
нужны проектные/графовые инструменты или read-only доступ к опубликованному OData 1С.
Смысловые артефакты по-прежнему создают только роли, заданные в
